package pl.hgawrys.AutomatedTestHelper;

import org.springframework.stereotype.Component;
import pl.hgawrys.AutomatedTestHelper.Models.IndexedField;
...
public class VariableCreator {
    ...
    public String getVariables(String dataInput) {
...
//            BufferedReader br = new BufferedReader(new FileReader(importedFile));
            Reader stringReader = new StringReader(dataInput);
        ...
        for (
            ...
            if (i != fieldsList.size() - 1 && fieldsList.get(i + 1).getIndexNumber() > fieldsList.get(i).getIndexNumber()) {
                ...
                dataOutput.append(firstLineToPrint).append("\n").append(secondLineToPrint).append("\n").append("\n");
